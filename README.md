...
[Bot repo](https://github.com/raspersc2/what)

---
# what?
Zerg has access to a variety of sharp, sometimes gimmicky strategies that tend to appear and disappear on 
...
The `zerg_builds.yml` file can be edited to test against specific builds.